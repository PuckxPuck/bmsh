<div class="modal" x-bind:style="payNowModal && { 'pointer-events':'auto', 'visibility':'visible', 'opacity':1 }" x-transition>
    <div class="modal-box rounded-[3rem] text-center" @mousedown.outside="payNowModal = false">
        <h3 class="font-bold text-4xl mb-4">September Payment</h3>
        <hr>
        <div class="px-10">
